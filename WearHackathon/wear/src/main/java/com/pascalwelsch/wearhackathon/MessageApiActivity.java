...
public class MessageApiActivity extends Activity implements View.OnClickListener,
        GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener,
        MessageApi.MessageListener {

    private static final String TAG = MessageApiActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.hello_button).setOnClickListener(this);
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                for (String nodeId : getNodes()) {
                    sendToDevice(nodeId, "/hello", "hello world");
                }
            }
        }).start();
    }
        ...
        final ResultCallback<MessageApi.SendMessageResult> resultCallback
            ...
            public void onResult(final MessageApi.SendMessageResult sendMessageResult) {
                if (!sendMessageResult.getStatus().isSuccess()) {
                    ...
                    Toast.makeText(MessageApiActivity.this, "sending message failed",
                            Toast.LENGTH_SHORT).show();
                } else {
                    Log.v(TAG, "message successfully sent");
                    Toast.makeText(MessageApiActivity.this, "sent",
                            Toast.LENGTH_SHORT).show();
                }
            }
        };
